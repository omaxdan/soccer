...
const overview = (
  ...
  return (
    <div className="space-y-4">
      ...
      {/* ── MODULE REPORT — scrollable, no tabs ─────────── */}
      <ModuleReport
        match={m}
      ...
      <Collapsible title="Overview">{overview}</Collapsible>
      <Collapsible title="Goals">{goals}</Collapsible>
      <Collapsible title="Players">{players}</Collapsible>
      <Collapsible title="Signals">{signalsTab}</Collapsible>
      <Collapsible title="Teams">{teams}</Collapsible>
      <Collapsible title="Matchups">{matchups}</Collapsible>
      <Collapsible title="Risk">{risk}</Collapsible>
    </div>
  );
}
