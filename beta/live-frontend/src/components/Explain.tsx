...
export function EvidenceDisclosure({
  ...
  // Expanded by default: the "why" behind a signal is the point of the
  // page, not an optional aside. The toggle stays so a user who wants a
  // denser view can still collapse it, but nobody should have to tap
  // "why" just to see why.
